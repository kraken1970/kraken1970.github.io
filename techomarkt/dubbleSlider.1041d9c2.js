...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/JS/dubbleSlider.js":[function(require,module,exports) {
function dubleSlider() {
  var sliderElem = document.querySelector(".scale");
  var thumbMin = document.querySelector(".toggle-min");
  var thumbMax = document.querySelector(".toggle-max");
  var bar = document.querySelector(".bar");
  var minPriceInput = document.querySelector(".min_price--input");
  var maxPriceInput = document.querySelector(".max_price--input");
  ...
  var devider = maxPriceInput.value / max;
  ...
  thumbMin.onmousedown = function (e) {
    ...
    document.onmousemove = function (e) {
      var newLeft = e.pageX - shiftX - sliderCoords.left; //если вне слайдера
  ...
  var deltaBar = function deltaBar() {
    return getCoords(thumbMax).left - getCoords(thumbMin).left;
  };

  minPriceInput.onchange = function (e) {
    e.preventDefault();
    var leftChange = parseInt(minPriceInput.value / devider);
  ...
  maxPriceInput.onchange = function (e) {
    e.preventDefault();
    var rightChange = parseInt(maxPriceInput.value / devider);
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/JS/dubbleSlider.js"], null)
//# sourceMappingURL=/dubbleSlider.1041d9c2.map