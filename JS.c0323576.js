...
// Слайдер
var slideLeftControl = document.querySelector(".slide-left");
var slideRightControl = document.querySelector(".slide-right");
var dotLeft = document.querySelector(".dot-left");
var dotRight = document.querySelector(".dot-right");
var slideContainer = document.querySelector(".slide-container");
var width = document.querySelector(".slide1").clientWidth;
...
var btnServices = document.querySelectorAll(".our_services-block");
var serviceContent = document.querySelectorAll(".our_services-content");

var _loop = function _loop(i) {
  btnServices[i].onclick = function () {
    for (var j = 0; j < btnServices.length; j++) {
      if (j === i) {
...
var activeFormSend = document.querySelector(".map_company-btn");
var formSend = document.querySelector(".modal_content--write-us");
var closeFormSend = formSend.querySelector(".modal-content-close");

activeFormSend.onclick = function (event) {
  event.preventDefault();
  formSend.classList.remove("block-none");
};

closeFormSend.onclick = function (event) {
  event.preventDefault();
